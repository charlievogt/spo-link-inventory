...
Tenant-wide SharePoint Online link inventory and duplicate-file detection. Ships as an Azure Function backend plus an SPFx admin web part.
...
```
SPFx Admin Web Part           ← admin UI: scan / browse / find&replace / dupes
       │ AadHttpClient (OBO)
       ▼
Azure Function HTTP triggers  ← /api/link-inventory/*, /api/duplicates/*
       │
       ...
       │
       ├── Job state ──────► Azure Table (link inventory + duplicates jobs)
